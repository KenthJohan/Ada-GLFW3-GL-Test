...
package Maths is
   ...
   use Generic_Matpack;
   use Generic_Matpack.Projections;
   use Generic_Matpack.Quaternions;
   ...
   function "*" is new Quaternions.Generic_Quaternion_Quaternion_Hamilton_Product (Dimension_4, GLfloat, Vector_4, 0.0);
   ...
   procedure Make_Perspective_Matrix is new Projections.Generic_Matrix_Perspective_Conversion (Dimension_4, GLfloat, Matrix_4, 1.0, 2.0, Elementary_Functions.Tan);
   ...
   procedure Make_Rotation_Matrix is new Quaternions.Generic_Quaternion_Matrix_4_Conversion (Dimension_4, GLfloat, Vector_4, Matrix_4, 2.0);
